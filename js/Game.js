...
showFuelBar(){
  push();
  image(fuelImage, width/2 - 130, height - player.positionY, 20, 20);
  fill("white");
  rect(width/2 - 100, height - player.positionY, 185, 20);
  fill("#ffc400");
  rect(width/2 - 100, height - player.positionY, player.fuel, 20);
  noStroke();
  pop();
}
